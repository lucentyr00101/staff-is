...
<body>
	...
	<div class="row">
		<div class="container">
			...
			<div class="field-container">
				...
				<div class="row">
					...
					<div class="staff-field col-md-6">
						...
						<div class="field-content">
							<input type="tel" id="phone" class='form-control' name='telephone_no' required>
			...
			<div class="field-container">
				<h2 class="fs-title">Banking Information <span style="color:Red; font-size:16px;">*</span></h2> 
